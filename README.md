...
- Обновляйте CSV только при осознанной необходимости. Если данные готовятся внешними скриптами/Excel, сохраняйте результат в `utf-8-sig` и оформляйте отдельный коммит, чтобы ревьюеры увидели дифф по строкам.
- `data/plan.csv` разрешено редактировать вручную (меняются статусы машин по сменам). В README/PR фиксируйте причину изменения плана.
